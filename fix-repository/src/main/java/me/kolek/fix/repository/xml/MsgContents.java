 ...
 *       &lt;sequence&gt;
 *         &lt;element name="MsgContent" type="{}MsgContent_cs_t" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
@XmlRootElement(name = "MsgContents")
public class MsgContents {

    @XmlElement(name = "MsgContent")
    protected List<MsgContentCsT> msgContent;
     ...
     * This is why there is not a <CODE>set</CODE> method for the msgContent property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getMsgContent().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<MsgContentCsT> getMsgContent() {
        if (msgContent == null) {
            msgContent = new ArrayList<MsgContentCsT>();
        }
