 ...
 *       &lt;sequence&gt;
 *         &lt;element name="Field" type="{}Field_cs_t" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class Fields {
     ...
     * 
     */
    public List<FieldCsT> getField() {
        if (field == null) {
            field = new ArrayList<FieldCsT>();
        }
        return this.field;
    }
